...
Комментарии начинается и **обязательно** заканчивается символом
...
По аналогии с C/C++ основная функция, которая должна присутствовать в любой программе и именно с нее начинается исполние программы. Обозначается
